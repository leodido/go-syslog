...
#  1 ..  9, 01 .. 09, 10..31
#
# The day of the month, see RFC 3164, section 4.1.2. Our parsing is more
# lenient: 01 .. 09 is not accepted under the RFC, but is generated by some
# systems.
datemday = (sp . nonzerodigit | '0' . nonzerodigit | '1'..'2' . '0'..'9' | '3' . '0'..'1');
